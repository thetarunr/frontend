        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#" className="text-gray-300 hover:text-white transition-colors">Book Turf</a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">123 Sports Avenue, Bengaluru, Karnataka, India</span>
              </li>
              <li className="flex items-center">
                <Phone className="w-5 h-5 mr-2 text-green-500" />
                <span className="text-gray-300">+91 99407 67771</span>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-2 text-green-500" />
                <span className="text-gray-300">info@levelupturf.com</span>
              </li>
            </ul>
          </div>
        </div>
